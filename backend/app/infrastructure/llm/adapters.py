        ...
        messages = [
            SystemMessage(
                content=(
                    ...
                    "Interprete linguagem cotidiana: porta emperrada ou que não abre descreve "
                    "o problema; 'agora', 'urgente' e 'o mais rápido possível' significam "
                    "disponibilidade imediata pelas próximas quatro horas."
                )
            ),
            HumanMessage(
                content=(
